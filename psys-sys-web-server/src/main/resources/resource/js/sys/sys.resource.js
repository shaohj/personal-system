var _listTreeAllResourceUrl = secContext + "/sys/resource/query/listTreeAll?access_token="+userToken,
	_saveOrUpdateResourceUrl = secContext + "/sys/resource/saveOrUpdate?access_token="+userToken,
	_delByCodeUrl = secContext + "/sys/resource/del/delByCode",
	_getByCodeUrl = secContext + "/sys/resource/query/getByCode";
