...
Showbo.Msg={  
    ...
    InitMsg:function(width){  
      ...
      html='<div class="top"><div class="boxright"><div class="title" id="dvMsgTitle"></div></div></div>'+  
        '<div class="body"><div class="boxright"><div class="ct" id="dvMsgCT"></div></div></div>'+  
        '<div class="bottom" id="dvMsgBottom"><div class="boxright"><div class="boxbtn" id="dvMsgBtns"></div></div></div>';  
    ...
    createBtn:function(p,v,fn){  
        ...
        btn.value=v;  
        btn.onmouseover=function(){this.className='boxbtnfocus';}  
        btn.onmouseout=function(){this.className='boxbtn';}  
    ...
    show:function(cfg){  
      ...
      if(cfg.waitHide){
        hideCfg=window.setTimeout(function(){Showbo.Msg.hide();},this.showTime);
      };
