    ...
    $.sprFlat = function(element, options) {
        ...
        var defaults = {
            ...
            backToTop: {
                ...
                imgsrc: contextPath + '/assets/img/backtop.png', //image
        ...
        plugin.setCurrentNav = function () {
            ...
            if(domain === '') {
                ...
                if(plugin.settings.sideNav.absoluteUrl) {
                    ...
                    if(afterDomain == contextPath + "/"){
                        afterDomain = contextPath + "/index"; //设置首页修改 shaohj
                    }
        ...
        plugin.breadCrumbs = function () {
            ...
            breadcrumb.append('<li>'+homeIcon+'<a href='+indexUrl+'>首页</a>'+rightArrow+'</li>');
