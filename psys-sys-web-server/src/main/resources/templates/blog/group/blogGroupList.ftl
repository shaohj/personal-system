	...
	<div class="content-wrapper">
		<div class="row">
			...
			<div class="col-lg-12 heading">
				<h1 class="page-header"><i class="im-table2"></i> 博客群组</h1>
				<!-- Start .bredcrumb -->
							...
							<div class="slimScrollDiv" style="position: relative; overflow: hidden; width: 100%; height: auto;">
								<div class="table-responsive" style="overflow: hidden; width: 100%; height: auto;">
                                   ...
                                   <div class="do-icons" style="float:right">
                                       <ul>
                                           <li><a href="javascript:void(0)" id="add-bloggroup-button" ><i class="fa fa-plus"></i>新增</a></li>
                                           <li><a href="javascript:void(0)" id="mod-bloggroup-button" ><i class="fa fa-edit"></i>修改</a></li>
                                           <li><a href="javascript:void(0)" onclick="javascript:void(0)" id="del-role-button" ><i class="fa fa-remove"></i>删除</a></li>
                                       </ul>
                                   </div>
...
<script>
    ...
    function searchForPage(pageNumParam){
        ...
        var url = appendUrlRandom("${ctx}/blog/group/to/listData?page="+pageNum+"&size="+pageSize); //添加随机数,无缓存请求
