...
import com.psys.hobb.common.http.bean.HeaderParams;
...
public class RestUtils {
	...
	public static void downFile(String url, String folder, String fileName, HeaderParams headerParams)
    		throws IllegalArgumentException, SysRuntimeException {
	...
	public static void downFile(String url, String filePath, HeaderParams headerParams)
		...
		try {
			...
			logger.error("{}", e);
			throw new SysRuntimeException(SysRuntimeException.DEFAULT_FAIL_CODE, "IOException." + e.getMessage());
		} finally {
			IOUtils.close(out);
		}
	}
	...
	public static <T> T sendRequest(String url, HttpMethod httpMethod, HeaderParams headerParams, String bodyStr, Class<T> cls)
		...
		try {
			...
			logger.error("{}", e);
			throw new SysRuntimeException(SysRuntimeException.DEFAULT_FAIL_CODE, "发送http请求失败." + e.getMessage());
		} catch (HttpMessageNotReadableException e) {
			logger.error("{}", e);
			throw new SysRuntimeException(SysRuntimeException.DEFAULT_FAIL_CODE, "请求返回数据类型与参数返回类型不一致." + e.getMessage());
		}
